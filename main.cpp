...
{  
    ...
    Texture t1,t2;
    // Пробуем загрузить из локальной папки, затем из системной
    if (!t1.loadFromFile("images/white.png") || !t2.loadFromFile("images/red.png")) {
        if (!t1.loadFromFile("/usr/share/snake-game/images/white.png") || 
            !t2.loadFromFile("/usr/share/snake-game/images/red.png")) {
            return EXIT_FAILURE;
        }
    }
